...
<body>
    ...
    <div class="main-title">
        <h2><?php echo isset($info['id'])?'编辑':'新增';?>租售信息</h2>
    </div>
    <form action="<?php echo U();?>" method="post" enctype="multipart/form-data" class="form-horizontal" >
        <div class="form-item">
            <label class="item-label">发布人<span class="check-tips"></span></label>
            <div class="controls">
                <input type="text" class="text input-large" name="issuer" value="<?php echo ((isset($info["issuer"]) && ($info["issuer"] !== ""))?($info["issuer"]):''); ?>">
            </div>
        </div>
        <div class="form-item">
        ...
        <div class="form-item">
            ...
            <div class="controls">
                <input type="text" class="text input-small" name="price" value="<?php echo ((isset($info["price"]) && ($info["price"] !== ""))?($info["price"]):0); ?>">
                <select name="unit">
        ...
        <div class="form-item">
            ...
            <div class="controls">
                <select name="type">
                    ...
                    <option value="0" <?php if(($info["target"]) == "0"): ?>selected<?php endif; ?>>出售</option>
                    <option value="1" <?php if(($info["target"]) == "1"): ?>selected<?php endif; ?>>销售</option>
                </select>
            </div>
        </div>
        <div class="form-item">
            ...
            <div class="controls">
                <select name="status">
                    ...
                    <option value="0" <?php if(($info["status"]) == "0"): ?>selected<?php endif; ?>>启用</option>
                    <option value="1" <?php if(($info["status"]) == "1"): ?>selected<?php endif; ?>>禁用</option>
                </select>
            </div>
        </div>
        <div class="form-item">
            ...
            <div class="controls">
                <input type="date" class="text input-large" name="end_time" value="{<?php echo (date('Y-m-d H:i:s',$info["time"])); ?>}">
            </div>
        </div>
        <div class="form-item">
            ...
            <div class="controls">
                ...
                <script src="/Public/static/ueditor/ueditor.config.js"></script>
                <script src="/Public/static/ueditor/ueditor.all.min.js"></script>
        ...
        <div class="form-item">
            ...
            <div class="controls">
                ...
                <input type="hidden" value="<?php echo ($info["img"]); ?>"  name="img" id="db_img"> <!--存进数据库的-->
                <input id="upload_button" type="file" multiple="multiple" value=""/><!--上传按钮-->


                <img src="<?php echo ($info["img"]); ?>" alt="" id="sale_img"><!--回显图片-->
